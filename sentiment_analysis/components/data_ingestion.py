...
class DataIngestion:
    ...
    def get_data_from_local(self) -> None:
        try:
            ...
            os.makedirs(self.data_ingestion_config.DATA_INGESTION_ARTIFACTS_DIR, exist_ok=True)
            shutil.copy( "sentiment_analysis/data/" + self.data_ingestion_config.ZIP_FILE_NAME, self.data_ingestion_config.ZIP_FILE_PATH  )
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifacts:
        ...
        try:
            ...
            logging.info("Fetched the data from local")
